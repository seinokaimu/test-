...
class Wallet(object):
    ...
    def generate_blockchain_address(self):  
        ...
        # 8  Encording the key with Base58
...
if __name__ == '__main__':
    ...
    is_added = block_chain.add_transaction(wallet_A.blockchain_address, wallet_B.blockchain_address, 1.0, wallet_A.public_key, t.generate_signature())
