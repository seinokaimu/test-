...
class BlockChain(object):
    ...
    def set_neighbours(self):
        self.neighbours = utils_test.find_neighbours(
            utils_test.get_host(), self.port,
    ...
    def create_block(self, nonce, previous_hash):
        block = utils_test.sorted_dict_by_key({
            'timestamp' : time.time(),
    ...
    def add_transaction(self, sender_blockchain_address, recipient_blockchain_address, value, sender_public_key = None, signature = None):
        transaction = utils_test.sorted_dict_by_key({
    ...
    def valid_proof(self, transactions, previous_hash, nonce, difficulty = MINING_DIFFICULTY):
        guess_block = utils_test.sorted_dict_by_key({
